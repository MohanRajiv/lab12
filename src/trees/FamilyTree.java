...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        ArrayList<TreeNode> collectAncestorsToList()
        {
            ...
            for (TreeNode a = parent; a != null; a = a.parent)
        	{
            	ancestors.add(a);        	
            }
            return ancestors;
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("colon missing");
		...
		else
		{
			...
			if (parentNode == null)
				throw new TreeException("couldn't find parent");
		}
		
		// Add child nodes to parentNode.
		// ?? For each name in childrenArray, create a new node and add that node to parentNode.
		for (String children2 : childrenArray)
		{
			parentNode.children.add(new TreeNode(children2));
		}
	}
